...
if [ "$DATASET" == "mnist" ]; then
    MEM_SIZE=500 TOTAL=50000 N_VAL=250 N_CLASS=10 TOPK=1
    if [ "$BACKBONE" == "basic" ];
    then
    ...
    MEM_SIZE=2000 TOTAL=50000 N_VAL=0 N_CLASS=100 TOPK=1
    if [ "$BACKBONE" == "basic" ];
    then
        MODEL_NAME="resnet32"; LR=0.05
    else
        MODEL_NAME="ViT"; LR=0.005
    fi
    ...
    MEM_SIZE=20000 TOTAL=50000 N_VAL=0 N_CLASS=1000 TOPK=5
    if [ "$BACKBONE" == "basic" ];
    then
